...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/dovnaravwork/netcloak-android"
    const val APP_API_URL = "https://api.github.com/repos/dovnaravwork/netcloak-android/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/dovnaravwork/netcloak-android/master/CR.md"
    const val APP_PROMOTION_URL = ""
    const val TG_CHANNEL_URL = "https://t.me/netcloak"
    ...
    const val RAY_NG_CHANNEL_NAME = "NetCloak Background Service"
